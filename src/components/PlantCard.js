        ...
        <Col>
          {props.posts.map((res) => (
            <Col
              ...
              value={res.id}
              style={
                ({ backgroundColor: "darkgray" }, { paddingTop: "1.5rem" })
              }
            >
              <Alert color="warning" style={{ textDecoration: "underline" }}>
                {res.title}
              </Alert>
              ...
              <Button value={res.id} onClick={editFunc}>
                Edit Story
              </Button>
              <Button color="danger" value={res.id} onClick={deleteFunc}>
                DELETE
              </Button>
            </Col>
          ))}
